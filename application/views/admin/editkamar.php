	...
	<form action="<?php echo base_url() . 'admin/update_kamar' ?>" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<select name="tipe_kasur" class="form-control">
				<option <?php if ($k->tipe_kasur == "Single Bed") {
							echo "selected='selected'";
						}
						echo $k->tipe_kasur; ?> value="Single Bed">Single Bed</option>
				<option <?php if ($k->tipe_kasur == "Twin Bed") {
							echo "selected='selected'";
						}
						echo $k->tipe_kasur; ?> value="Twin Bed">Twin Bed</option>
				<option <?php if ($k->tipe_kasur == "Double Bed") {
							echo "selected='selected'";
						}
						echo $k->tipe_kasur; ?> value="Double Bed">Double Bed</option>
			</select>
		...
		<div class="form-group">
			...
			<select name="lokasi" class="form-control">
				<option <?php if ($k->lokasi == "Lantai 1") {
							echo "selected='selected'";
						}
						echo $k->lokasi; ?> value="Lantai 1">Lantai 1</option>
				<option <?php if ($k->lokasi == "Lantai 2") {
							echo "selected='selected'";
						}
						echo $k->lokasi; ?> value="Lantai 2">Lantai 2</option>
				<option <?php if ($k->lokasi == "Lantai 3") {
							echo "selected='selected'";
						}
						echo $k->lokasi; ?> value="Lantai 3">Lantai 3</option>
			</select>
		...
		<div class="form-group">
			...
			<select name="status_kamar" class="form-control">
				<option <?php if ($k->status_kamar == "1") {
							echo "selected='selected'";
						}
						echo $k->status_kamar; ?> value="1">Tersedia</option>
				<option <?php if ($k->status_kamar == "0") {
							echo "selected='selected'";
						}
						echo $k->status_kamar; ?> value="0">Isi</option>
			</select>
